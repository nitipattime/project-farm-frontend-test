...
required
        ...
        <VCardText>
          <VRow dense>
            ...
            >
              <VSelect
                v-model="farmForm.subdistrict"
                label="ตำบล/แขวง"
                :items="selectedSubdistricts"
                :rules="[requiredRule]"
                required
              />
            </VCol>
