...
<template>
            ...
            density="comfortable" style="max-width: 300px" />
                ...
                <div class="d-flex justify-space-between align-center mb-6">
                    ...
                    <VTextField v-model="searchQuery" placeholder="ค้นหา" persistent-placeholder :loading="loading"
                        append-inner-icon="mdi-magnify" @click:append-inner="onSearch" clearable hide-details
    ...
    <div class="pa-4 text-center">
        <v-dialog v-model="dialog" max-width="600">
            <v-card>
                <v-card-title class="text-h6 text-md-h5 text-lg-h4 mt-2">ข้อมูลโรงเรือน</v-card-title>
                <v-card-text>กรอกข้อมูลโรงเรือนให้ครบถ้วน</v-card-text>
                ...
                <v-card-text class="mt-6">
                    <v-row dense>
                        <v-col cols="12" md="12" sm="6">
                            <v-text-field label="ชื่อโรงเรือน" v-model="farmForm.name" :rules="[requiredRule]"
    ...
    <VRow>
        <VCol cols="12">
            <VCard>
                <v-card-text>
                    <v-text-field base-color="black" :loading="loading" append-inner-icon="mdi-magnify"
                        density="compact" label="Search" variant="solo" hide-details single-line
                        @click:append-inner="onClick"></v-text-field>
                    <v-text-field class="black-label" :loading="loading" append-inner-icon="mdi-magnify"
                        density="compact" label="Search templates" variant="solo" hide-details single-line
                        @click:append-inner="onClick"></v-text-field>
                    <v-text-field color="on-surface" class="text-black" :loading="loading"
                        append-inner-icon="mdi-magnify" density="compact" label="Search templates" hide-details
    ...
    <VRow>
        <VCol cols="12">
            <VCard class="pa-6">
                ...
                <!-- Filter Dropdown -->
                <div class="d-flex justify-space-between align-center mb-6">
                    <VSelect v-model="selectedFilter" :items="filters" density="comfortable" hide-details
